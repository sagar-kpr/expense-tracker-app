    ...
    >
      <View style={{ flex: 1 }}>
        <Animated.View entering={FadeInUp.delay(100).duration(700)}>
          ...
          >
            Setup your{"\n"}
            <Text style={{ color: "#159B7D" }}>business</Text>
          </Text>
          ...
          >
            We will use this to personalize your income, expense, and business
            profit tracking.
          </Text>
        </Animated.View>

        <View style={{ marginTop: 52, gap: 22 }}>
          ...
          <Animated.View entering={FadeInDown.delay(350).duration(700)}>
            ...
            >
              This can be your shop, freelance brand, company, or personal
              business name.
            </Text>
          </Animated.View>
        </View>
        ...
        <Animated.View
          ...
          style={{ marginTop: "auto", paddingTop: 42 }}
        >
          <Pressable
